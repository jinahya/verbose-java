...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils1.java[lines=27..35]
----
<1> 버퍼를 하나 생성하고
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils1.java[lines=37..43]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=34..48]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=50..63]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=76..84]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=86..99]
----
...
.IoUtils2.java#copy2(Path,Path);
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=101..114]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils1.java[lines=35..45]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils1.java[lines=47..53]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils1.java[lines=65..70]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils2.java[lines=30..40]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils2.java[lines=42..47]
----
...
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=41..47]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=48..57]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=58..68]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::../../../../hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=69..69]
----
...
include::../../../../percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentEncoder.java[lines=39..50]
----
<1> `decoded` 버퍼에 인코드할 바이트가 남아있은 동안 반복한다. `encoded` 버퍼에 저장할 공간이 없는 경우에도 `BufferOverflowException` 이 발생하므로 확인하지 않는다.
<2> `encodeOctet(int,ByteBuffer)` 메서드가 `BufferOverflowException` 을 던지면 `decoded` 버퍼의 위치를 복귀시킨 후 반복 구문을 빠져나간다.
...
include::../../../../percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentEncoder.java[lines=59..64]
----
...
----
include::../../../../percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentEncoder.java[lines=75..82]
----
...
include::../../../../percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentDecoder.java[lines=37..48]
----
...
include::../../../../percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentDecoder.java[lines=57..62]
----
...
.PercentDecoder.java#decode(ByteBuffer)
----
include::../../../../percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentDecoder.java[lines=74..81]
----
<1> 문자열로부터 입력 배열을 생성한다.
...
include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=40..43]

include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=75..77]
}
----
...
----
include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=50..52]
----
...
----
include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=54..73]
----
...
include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=38..41]

include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=72..74]
}
----
...
----
include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=49..51]
----
...
----
include::../../../../percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=53..70]
----
