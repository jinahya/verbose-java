...
[cols=">1,>1,>2,>1,<2",frame="top",options="header"]
.8-bit values
|===============================================
...
include::../../../../hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexEncoder.java[lines=41..48]
----
...
include::../../../../hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexEncoder.java[lines=57..63]
----
...
include::../../../../hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexEncoder.java[lines=73..79]
----
<1> `charset` 을 이용해 주어진 문자열에서 입력 배열을 생성한다.
<2> 두배의 길이를 갖는 출력 배열을 생성한다.
<3> 이 두 배열을 감싸는 버퍼들을 생성하고 `encoded(ByteBuffer, ByteBuffer)` 를 호출한다.
